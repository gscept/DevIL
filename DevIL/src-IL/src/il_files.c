...
thread_local ILHANDLE	FileRead = NULL, FileWrite = NULL;
thread_local const void *ReadLump = NULL;
thread_local void 		*WriteLump = NULL;
thread_local ILuint		ReadLumpPos = 0, ReadLumpSize = 0, ReadFileStart = 0, WriteFileStart = 0;
thread_local ILuint		WriteLumpPos = 0, WriteLumpSize = 0;

thread_local fGetcProc	GetcProcCopy;
thread_local fReadProc	ReadProcCopy;
thread_local fSeekRProc	SeekProcCopy;
thread_local fTellRProc	TellProcCopy;
thread_local ILHANDLE	(ILAPIENTRY *iopenCopy)(ILconst_string);
thread_local void		(ILAPIENTRY *icloseCopy)(ILHANDLE);

thread_local fPutcProc	PutcProcCopy;
thread_local fSeekWProc	SeekWProcCopy;
thread_local fTellWProc	TellWProcCopy;
thread_local fWriteProc	WriteProcCopy;
thread_local ILHANDLE	(ILAPIENTRY *iopenwCopy)(ILconst_string);
thread_local void		(ILAPIENTRY *iclosewCopy)(ILHANDLE);
